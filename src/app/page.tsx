...
export default function Home() {
  ...
  const [isAddingMedication, setIsAddingMedication] = useState<boolean>(false);// 얘
  ...
  return (
    <main className="main">
      ...
      {isAddingMedication && InputMeditation(medicationType, customTime, setIsAddingMedication, setMedications, setIntervalId, setMedicationType, setCustomTime)}
...
function InputMeditation(medicationType: string, customTime: string, setIsAddingMedication: any, setMedications: any, setIntervalId: any, setMedicationType: any, setCustomTime: any){
  ...
  const handleSubmitMedication = () => {
    if (medicationType && isValidTime(customTime)) {
      ...
      setMedications((prev : any) => [...prev, newMedication]);
